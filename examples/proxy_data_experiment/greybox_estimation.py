"""
=======================================================================
Example: Grey-Box System Identification
=======================================================================
...
This example demonstrates the following workflow:
  ...
  - Define grey box model structure (linear time-invariant state-space)
...
grey1_opt = opt_problem1.solve( 
                        # maximum attemps to find a solution
    initialization_strategies=["grey_box"]     # strategy to create initial guess
)

grey2_opt = opt_problem2.solve(                     # maximum attemps to find a solution
    initialization_strategies=["grey_box"]     # strategy to create initial guess
)
...
list_of_models = [ss1, ss2]
list_of_names = ["ss1", "ss2"]
