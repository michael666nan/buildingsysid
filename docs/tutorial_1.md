...
- The example data file is available in the GitHub repository: [github.com/michael666nan/buildingsysid/master/tutorial_data/](https://github.com/michael666nan/buildingsysid/master/tutorial_data/)
